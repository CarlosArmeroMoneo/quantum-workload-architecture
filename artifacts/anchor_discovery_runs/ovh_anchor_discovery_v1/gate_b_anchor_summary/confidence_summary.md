...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| `01_real_dense_ring6_amplitude.yaml` | `quick_turnaround` | `deep_search` | `balanced` | 0.620 | `False` | `False` | `low` | `inconclusive_vs_variance` |
...
| `08_parity_iqp_batched_heldout_medium.yaml` | `quick_turnaround` | `quick_turnaround` | `balanced` | 4.540 | `True` | `True` | `medium` | `inconclusive_vs_variance` |
...
| --- | ---: | --- | --- | --- | --- | --- |
| `01_real_dense_ring6_amplitude.yaml` | 8.737 | `inconclusive_vs_variance` | `inconclusive_vs_variance` | `False` | `low` | `False` |
| `02_real_dense_ring6_batched.yaml` | 54.003 | `inconclusive_vs_variance` | `inconclusive_vs_variance` | `False` | `low` | `False` |
...
| `06_star_graph_phase_amplitude_heldout_low.yaml` | 0.852 | `inconclusive_vs_variance` | `inconclusive_vs_variance` | `False` | `low` | `False` |
