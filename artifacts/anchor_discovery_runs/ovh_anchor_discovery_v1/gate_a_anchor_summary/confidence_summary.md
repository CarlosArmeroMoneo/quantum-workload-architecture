...
- high_confidence_top1_accuracy: `1.0`
- selection_confidence_counts: `{'low': 4, 'medium': 4, 'high': 1}`
...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| `01_real_dense_ring6_amplitude.yaml` | `quick_turnaround` | `balanced` | `quick_turnaround` | 9.865 | `False` | `False` | `medium` | `inconclusive_vs_variance` |
| `02_real_dense_ring6_batched.yaml` | `quick_turnaround` | `quick_turnaround` | `balanced` | 65.476 | `True` | `True` | `high` | `inconclusive_vs_variance` |
...
| `06_star_graph_phase_amplitude_heldout_low.yaml` | `quick_turnaround` | `quick_turnaround` | `balanced` | 0.128 | `True` | `True` | `low` | `inconclusive_vs_variance` |
| `07_ladder_brickwork_amplitude_heldout_medium.yaml` | `quick_turnaround` | `quick_turnaround` | `balanced` | 5.601 | `True` | `True` | `medium` | `None` |
| `08_parity_iqp_batched_heldout_medium.yaml` | `quick_turnaround` | `quick_turnaround` | `balanced` | 5.046 | `True` | `True` | `medium` | `inconclusive_vs_variance` |
...
| --- | ---: | --- | --- | --- | --- | --- |
| `01_real_dense_ring6_amplitude.yaml` | 9.865 | `inconclusive_vs_variance` | `None` | `False` | `low` | `False` |
| `02_real_dense_ring6_batched.yaml` | 0.000 | `None` | `inconclusive_vs_variance` | `False` | `low` | `False` |
...
| `06_star_graph_phase_amplitude_heldout_low.yaml` | 0.000 | `None` | `inconclusive_vs_variance` | `False` | `low` | `False` |
| `07_ladder_brickwork_amplitude_heldout_medium.yaml` | 0.000 | `None` | `None` | `False` | `low` | `False` |
| `08_parity_iqp_batched_heldout_medium.yaml` | 0.000 | `None` | `inconclusive_vs_variance` | `False` | `low` | `False` |
